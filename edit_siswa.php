...
if(isset($_POST['submit'])){
  ...
  $update = mysqli_query($conn, "UPDATE siswa SET nama='$nama', kelas='$kelas', jurusan='$jurusan' WHERE nis='$nis'");

    if($update){
        echo "<script>alert('Data siswa berhasil diperbarui'); window.location='data_siswa.php';</script>";
    }else{
        echo "<script>alert('Gagal memperbarui data siswa: ".mysqli_error($conn)."');</script>";
    }
}
?>
...
<title>Edit Siswa - SPP Online</title>
...
.form-container input { width:100%; padding:10px; margin-top:5px; border:1px solid #ccc; border-radius:6px; }
...
<div class="sidebar">
    ...
    <a class="active" href="data_siswa.php"><i class='bx bx-user'></i>Data Siswa</a>
...
<div class="main">
    ...
    <div class="form-container">
        <form method="POST">
            ...
            <input type="text" id="nis" value="<?php echo $siswa['nis']; ?>" disabled>
