...
if(isset($_GET['search'])){
    ...
    $query = "SELECT * FROM pembayaran 
              WHERE nis LIKE '%$keyword%' OR nama LIKE '%$keyword%'
...
<title>Data Pembayaran - SPP Online</title>
...
<div class="main">
    <div class="header">Data Pembayaran</div>

    <div style="display:flex; justify-content:space-between; align-items:center; margin-bottom:15px; flex-wrap:wrap;">
        <a href="tambah_pembayaran.php" class="btn btn-add">+ Tambah Pembayaran</a>

        <form method="GET" class="search-bar" style="display:flex; gap:10px;">
            <input type="text" name="search" placeholder="Cari NIS atau nama..." value="<?php echo htmlspecialchars($keyword); ?>">
        ...
        <table>
            ...
            <tbody>
                ...
                while($row = mysqli_fetch_assoc($result)){
                    ...
                    echo "<td>
                            <a href='edit_pembayaran.php?id=".$row['id']."' class='btn btn-edit'>Edit</a>
                            <a href='hapus_pembayaran.php?id=".$row['id']."' class='btn btn-delete' onclick=\"return confirm('Yakin ingin hapus pembayaran ini?')\">Hapus</a>
                          </td>";
                    echo "</tr>";
                }
                ?>
